"""
IDA fitting logic extracted from the GUI for reuse and testing.
"""
import numpy as np
...
class IDAFittingAlgorithm(BaseFittingAlgorithm):
    def fit(self, file_path, results_file_path, Kd_in_M, h0_in_M, d0_in_M, number_of_fit_trials, rmse_threshold_factor, r2_threshold, save_plots, display_plots, plots_dir, save_results_bool, results_save_dir, assay='ida'):
    ...
    def export_results(self, *args, **kwargs):
        # Implement as needed for exporting results
        pass

def run_ida_fitting(*args, **kwargs):
    """Wrapper for backward compatibility with GUI code."""
    algo = IDAFittingAlgorithm()
    return algo.fit(*args, **kwargs)
