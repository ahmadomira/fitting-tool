...
class DyeAloneFittingAlgorithm(BaseFittingAlgorithm):
    def fit(self, input_file_path, output_file_path, save_plots, display_plots, plots_dir):
        """Implements the abstract fit method by calling perform_fitting."""
        return self.perform_fitting(input_file_path, output_file_path, save_plots, display_plots, plots_dir)
    ...
    def perform_fitting(self, input_file_path, output_file_path, save_plots, display_plots, plots_dir):
        ...
        avg_slope, avg_intercept, retained_slopes, retained_intercepts, retained_indices = self.filter_and_average_results(fit_results)
