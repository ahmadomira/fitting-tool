...
- **Registries**: The system uses registries to map (object type, file extension) pairs to the appropriate
  reader or writer implementation. This enables plug-in support for new formats without modifying core logic.
- **Serializers**: Reader and writer plug-ins for specific formats (e.g., Parquet, NetCDF, XLSX) are
...
- `serialize`    : Reader/writer plug-ins for various file formats.
